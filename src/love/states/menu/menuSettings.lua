		...
		love.graphics.push()
			...
			love.graphics.push()
                ...
                elseif settingsMenuState == 2 then -- I need a better way for this lmfao
                    love.graphics.print("Downscroll = " .. tostring(settings.downscroll), -628, -360)
                    love.graphics.print("\n\nMiddlescroll = " .. tostring(settings.middleScroll), -628, -360)
                    love.graphics.print("\n\n\n\nGhost Tapping = " .. tostring(settings.ghostTapping), -628, -360)
                    love.graphics.print("\n\n\n\n\n\nSide Judgements = " .. tostring(settings.sideJudgements), -628, -360)
                    love.graphics.print("\n\n\n\n\n\n\n\nBot Play = " .. tostring(settings.botPlay), -628, -360)
                    love.graphics.print("\n\n\n\n\n\n\n\n\n\nCustom Scroll Speed = " .. tostring(settings.customScrollSpeed), -628, -360)
                    love.graphics.print("\n\n\n\n\n\n\n\n\n\n\n\nKeystrokes = " .. tostring(settings.keystrokes), -628, -360)
