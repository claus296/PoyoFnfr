return graphics.newSprite(
	love.graphics.newImage(graphics.imagePath("city/newGf")), -- Do not add the .png extension
	{
		...
		{x = 0, y = 754, width = 556, height = 777, offsetX = 0, offsetY = -9, offsetWidth = 556, offsetHeight = 786}, -- 8: right0000
		{x = 556, y = 754, width = 543, height = 775, offsetX = -2, offsetY = -2, offsetWidth = 556, offsetHeight = 786}, -- 9: right0001
		{x = 1099, y = 754, width = 529, height = 771, offsetX = -3, offsetY = 0, offsetWidth = 556, offsetHeight = 786}, -- 10: right0002
		{x = 1628, y = 754, width = 521, height = 766, offsetX = -3, offsetY = -6, offsetWidth = 556, offsetHeight = 786}, -- 11: right0003
		{x = 2149, y = 754, width = 514, height = 765, offsetX = -3, offsetY = -8, offsetWidth = 556, offsetHeight = 786}, -- 12: right0004
		{x = 2663, y = 754, width = 514, height = 765, offsetX = -3, offsetY = -8, offsetWidth = 556, offsetHeight = 786} -- 13: right0005
	},
	{
		["idle"] = {start = 1, stop = 13, speed = 12, offsetX = 0, offsetY = 0},
	},
